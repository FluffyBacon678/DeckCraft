...
// Repo-relative by default; the plugin sets DECKCRAFT_ITEMS_OUT when it runs this itself from
// inside the installed plugin folder on first launch.
const OUT_DIR = process.env.DECKCRAFT_ITEMS_OUT || "com.fluffybacon.deckcraft-hotbar.sdPlugin/imgs/items";
